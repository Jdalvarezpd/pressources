...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$sql = "UPDATE users SET password = :password, resetkey = :resetkey WHERE email = :email LIMIT 1";
        ...
        <div class="card" style="width: 20rem; margin-top: 10em;">
          <div class="card-body">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                <input type="password" id="inputEmail" name="newpass" class="form-control" placeholder="New Password" style="margin-bottom: 1em;" required autofocus>
